...
class ModelBuilder:
    ...
    def _log_model_statistics(model, test_input, test_target):
        ...
        for confidence_threshold in numpy.arange(0.9, 1, 0.01):
            logging.info("Model validation results for confidence threshold: {:.2}".format(confidence_threshold))
            ...
            logging.info("In hindsight, {} ({:.2%}) of them defaulted, resulting in a yearly after tax return of {:.2%}"
